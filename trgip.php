...
$hasil3=mysql_query("select SQL_NO_CACHE * from ip where id_perangkat='$_GET[id_perangkat]'");
$data3=mysql_fetch_array($hasil3);
$selisih=$waktu-strtotime($data3['waktu']);
if($selisih>300)
{
	mysql_query("update ip set waktu='$waktu_dummy' where id_perangkat='$_GET[id_perangkat]'");
	...
	echo "<b>Setting IP Port OK</b><br/><br/>";
	echo "<form>";
