...
$hasil=mysql_query("select SQL_NO_CACHE * from perangkat where id_grup=9");
$jumlah=mysql_num_rows($hasil);
echo "Jumlah Perangkat GPS QC : <b>$jumlah</b>";
...
echo "</div>";
$no=1;
$hasil1=mysql_query("select SQL_NO_CACHE * from perangkat where id_grup=9");
