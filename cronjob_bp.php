...
<html>
<head>
<title>Cronjob Server BP Group</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
</head>
<body>
<?
echo "<meta http-equiv=refresh content=10800;URL=$_SERVER[php_self]>";
echo "<br>";
echo "Refresh selalu berjalan setiap 3 jam apapun kondisinya<br>";
echo "Pengecekan data BP group yang lebih dari 3 jam dilakukan<br>";
...
while($data2=mysql_fetch_array($hasil2))
{
	...
	else if($waktu_selisih > 3600)
	{
		...
		$to = "bintangtrack@gmail.com,diamondbirdfarm@gmail.com,dhamsix@gmail.com";
		$subject = "Data perangkat BPGroup nopol ".$data2['no_kendaraan']." sudah telat lebih dari 1 jam";
		$message = "<html><body><span style=font-family:Arial;font-size:12px;>".
							 "Data perangkat BPGroup nopol ".$data2['no_kendaraan']." sudah telat lebih dari 1 jam</span></body></html>";
